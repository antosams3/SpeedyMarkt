    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.carrello) {
            if (carrello_count_number != 0) {
                ...
                Toast.makeText(this, "Devi prima selezionare dei prodotti!", Toast.LENGTH_SHORT).show();
        }
        ...
        if (item.getItemId() == R.id.inserisci_attivita) {
            if (tipo.equals("venditore")) {
                ...
                Toast.makeText(this, "Accesso riservato ai venditori", Toast.LENGTH_SHORT).show();
        ...
        @Override
        public void ongoPagamento (String idOrdine, String email, String prezzoNonArr, String
        nome, String via){
