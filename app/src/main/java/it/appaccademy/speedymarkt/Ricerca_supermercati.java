...
public class Ricerca_supermercati extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //Gestione tamarrate
        Animation slideinleft = AnimationUtils.loadAnimation(this.getContext(), R.anim.slide_in_left);
        ...
        textview19.startAnimation(slideinleft);
        textview44.startAnimation(slideinleft);
        textview43.startAnimation(slideinleft);
        textview47.startAnimation(slideinleft);
        textview46.startAnimation(slideinleft);
        ...
        textview21.startAnimation(slideinleft);
        textview24.startAnimation(slideinleft);
        textview27.startAnimation(slideinleft);
        textview26.startAnimation(slideinleft);
        textview23.startAnimation(slideinleft);
        textview25.startAnimation(slideinleft);
        ...
        textview22.startAnimation(slideinleft);
        textview42.startAnimation(slideinleft);
        textview40.startAnimation(slideinleft);
        textview41.startAnimation(slideinleft);
        textview38.startAnimation(slideinleft);
